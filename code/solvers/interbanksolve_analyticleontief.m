function [CHIm_0,CHIp_0,r_f_t,gammad_t,gammas_t,theta_t,CHIp_t,CHIm_t,Sigma_t,t_vec]=interbanksolve_analyticleontief(delta_r,theta_0,N,matchtech)
...
for tt=1:N
    [CHIm,CHIp,r_f,gammad,gammas,theta]=analytic_leontief(t_vec(tt),theta_0,delta_r,matchtech);
    theta_t(tt)=theta  ;
    gammas_t(tt)=gammas;
    gammad_t(tt)=gammad;
    CHIm_t(tt)=CHIm    ;
